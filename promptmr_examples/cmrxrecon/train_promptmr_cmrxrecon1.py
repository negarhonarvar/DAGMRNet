...
def build_args():
    ...
    #  data_path = pathlib.Path(r"D:\HPC\MultiCoil")
    data_path = pathlib.Path(r"F:\HPC\MultiCoil")
    ...
    checkpoint_dir = 'D:/Negar/PromptMR/promptmr_examples/cmrxrecon/checkpoints/'  # Specify the path to save model checkpoints 
