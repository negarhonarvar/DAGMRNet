...
if __name__ == '__main__':
    ...
    fully_cine_matlab_folder = join(data_path, "Cine/TrainingSet")
    ...
    # f = f_cine + f_mapping -- is the original code substitued with next line :
    f = f_cine
    ...
    for ff in tqdm(f):
        save_path = ff.replace('train',save_folder_name + '/train' ).replace('.mat', '.h5')
        ff.replace('val',save_folder_name + '/val').replace('.mat', '.h5')
    ...
    cine_h5_folder = fully_cine_matlab_folder.replace('train',save_folder_name)
