...
class CmrxReconDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        self.data_path = 'D:/Negar/MultiCoil/Cine/TrainingSet/h5_FullSample'
    ...
    def prepare_data(self):
        ...
        if self.use_dataset_cache_file:
            if self.test_path is not None:
                ...
                test_path ='D:/Negar/MultiCoil/Cine/TrainingSet/h5_FullSample/val' #None #self.data_path #/ f"{self.challenge}_test"
            data_paths = [
                'D:/Negar/MultiCoil/Cine/TrainingSet/h5_FullSample/train',# / f"{self.challenge}_train",
                'D:/Negar/MultiCoil/Cine/TrainingSet/h5_FullSample/val', # / f"{self.challenge}_val",
                test_path,
            ]
            data_transforms = [
            ...
            for i, (data_path, data_transform) in enumerate(
                ...
                _ = CmrxReconSliceDataset(
                    root=data_path,
                    # root = pathlib.Path(r"D:\Negar\MultiCoil\Cine\TrainingSet\h5_FullSample") ,
                    transform=data_transform,
                    sample_rate=sample_rate,
                    volume_sample_rate=volume_sample_rate,
                    challenge=self.challenge,
